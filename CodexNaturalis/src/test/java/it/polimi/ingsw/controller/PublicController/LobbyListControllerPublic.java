...
public class LobbyListControllerPublic {
    ...
    public synchronized void createLobby(String creator, String lobbyName, int maxPlayerCount, GameControllerReceiverPublicInterface gameReceiver) {
        ...
        if(lobbyMap.get(lobbyName)!=null || gameMap.get(lobbyName)!=null) {
            ...
            lobbyMap.put(lobbyName, new LobbyControllerPublic(lobbyCreated));
    ...
    public synchronized void joinLobby(String joiner, String lobbyName, GameControllerReceiverPublicInterface gameReceiver) {
        LobbyControllerPublic lobbyToJoin = lobbyMap.get(lobbyName);
    ...
    private synchronized GameControllerPublic getGameFromUserNick(String nickName) {
    ...
    private synchronized LobbyControllerPublic getLobbyFromUserNick(String nickName) {
