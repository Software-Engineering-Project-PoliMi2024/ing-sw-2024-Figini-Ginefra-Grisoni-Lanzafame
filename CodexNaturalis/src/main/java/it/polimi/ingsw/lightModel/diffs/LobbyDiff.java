...
public class LobbyDiff implements ModelDiffs<LightLobby>{
     ...
     */
    public LobbyDiff(List<String> add, List<String> remove) {
     ...
     * @param remove the nicknames to remove
     */
    public LobbyDiff(LobbyDiff lobbyDiff, List<String> add, List<String> remove) {
