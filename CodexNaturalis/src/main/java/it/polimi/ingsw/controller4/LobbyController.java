...
public class LobbyController {
    ...
    public synchronized GameController startGame(CardTable cardTable){
        ...
        Deck<GoldCard> goldCardDeck = new Deck<>(0, cardTable.getCardLookUpGoldCard().getQueue());
        Deck<StartCard> startingCardDeck = new Deck<>(2, cardTable.getCardLookUpStartCard().getQueue());
